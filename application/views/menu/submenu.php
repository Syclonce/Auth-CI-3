                ...
                <tbody>
                    ...
                    <?php foreach ($subMenu as $sm) : ?>
                        <tr>
                            ...
                            <td><?= $sm['is_active']; ?></td>
                            <td>
                                <a href="" data-toggle="modal" data-target="#eeditSubMenuModal<?= $sm['id'] ?>" class="badge badge-success">edit</a>
                                <a href="<?= base_url('menu/deleteSubMenu/' . $sm['id']) ?>" class="badge badge-danger" onclick="return confirm('Apakah anda yakin untuk menghapus <?= $sm['menu']; ?> ?')">delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
